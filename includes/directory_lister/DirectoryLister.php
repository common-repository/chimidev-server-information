...
class DirectoryLister {
    ...
    public function __construct() {
        ...
        $this->_appURL = admin_url() . 'admin.php?page=' . CHIMIDEV_SERVER_INFORMATION_DIR_SLUG_FOR_LISTER;
    ...
    public function listBreadcrumbs($directory = null) {
        ...
        foreach ($dirArray as $key => $dir) {
            ...
            if ($dir != '.') {
                ...
                $link = $this->_appURL . '&chimidev_si_dir=' . rawurlencode($dirPath);
                ...
                if ($file == '..') {
                    ...
                    if ($this->_directory != '.') {
                        ...
                        if (!empty($directoryPath)) {
                            $directoryPath = '&chimidev_si_dir=' . rawurlencode($directoryPath);
                        }
                    ...
                    if ($this->_directory != '.' || $file != 'index.php') {
                        ...
                        if (is_dir($relativePath)) {
                            $urlPath = $this->containsIndex($relativePath) ? $relativePath : '?page=' . CHIMIDEV_SERVER_INFORMATION_DIR_SLUG_FOR_LISTER . '&chimidev_si_dir=' . $urlPath;
                        }
